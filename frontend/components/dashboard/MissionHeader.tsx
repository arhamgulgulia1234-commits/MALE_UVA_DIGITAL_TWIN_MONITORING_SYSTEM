    ...
    <header className="sticky top-0 z-30 border-b border-base-border bg-base-bg">
      <div className="mx-auto flex max-w-[1800px] flex-wrap items-center gap-4 px-4 py-3 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="flex items-baseline gap-2 font-display text-lg font-bold tracking-wide text-slate-100 sm:text-xl">
              {PRODUCT_NAME}
              <span className="font-mono text-[10px] font-medium uppercase tracking-[0.09em] text-brand-gold sm:text-[11px]">
                {TAGLINE}
              </span>
            </h1>
        ...
        <div className="ml-auto flex items-center gap-4 sm:gap-6">
          ...
          {isReplay && (
            <span className="flex animate-pulseGlow items-center gap-1.5 rounded-md border border-status-amber/50 bg-status-amber/15 px-2.5 py-1 font-mono text-[10px] font-bold uppercase tracking-[0.08em] text-status-amber">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className={clsx(
                "rounded-lg border px-4 py-1.5 font-display text-lg font-bold tracking-[0.08em]",
                style.bg,
                style.border,
                style.text,
                style.glow,
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              transition={{ duration: 0.25 }}
              className={clsx(
                "flex items-center gap-1.5 rounded-full border px-4 py-1.5 font-display text-lg font-bold tracking-[0.06em]",
                recoveryStyle.bg,
